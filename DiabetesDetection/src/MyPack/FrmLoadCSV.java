...
public class FrmLoadCSV extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mining User Events forr Health Care Data");
...
//                    ds[11] = tempInt;
                    ...
                    if(calledBy == 0){
                        //parent.dataSet.addElement(ds);
                        SingleEntry e = new SingleEntry(13, 16);
                        e.dataItem = ds;
                        for(int x=0;x<16;x++){
                            e.descr[x] = dataVec.elementAt(i)[x];
                        }
                      //  String query="insert into dataset  values('"+e.descr[0]+"','"+e.descr[1]+"','"+e.descr[2]+"','"+e.descr[3]+"','"+e.descr[4]+"','"+e.descr[5]+"','"+e.descr[6]+"','"+e.descr[7]+"','"+e.descr[8]+"','"+e.descr[9]+"','"+e.descr[10]+"','"+e.descr[11]+"','"+e.descr[12]+"','"+e.descr[13]+"','"+e.descr[14]+"','"+e.descr[15]+"')";
                     //   System.out.println(query);
                      //  DatabaseConnection.executeUpdate(query);
                        parent.dataSet.dataSet.addElement(e);
                    }else{
                        SingleEntry e = new SingleEntry(13, 16);
                        e.dataItem = ds;
                        ...
                        for(int x=0;x<15;x++){
                            e.descr[x] = dataVec.elementAt(i)[x];
                            System.out.append("Single entry");
                        }
                        parent.compareSet.dataSet.addElement(e);
                       // parent.compareSet.addElement(ds);
                    }
                }
            }catch(Exception e){
