...
public class PerformanceBarChart extends ApplicationFrame {
    String type="";
     
    public PerformanceBarChart(final String title) {
...
public PerformanceBarChart(final String title,String type) {
...
//        ResultSet rs=DatabaseConnection.executeQuery(query);
        try {
            dataset.addValue(500,"Correct", "Correct");
            dataset.addValue(0,"InCorrect", "InCorrect");
//            while(rs.next()){
...
//        dataset.addValue(6.0, series3, category5);
    ...
    public static void main(final String[] args) {
        ...
        final PerformanceBarChart demo = new PerformanceBarChart("Bar Chart Graph");
        demo.pack();
